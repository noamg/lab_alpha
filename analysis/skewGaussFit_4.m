function [fitResult,gof] = skewGaussFit_4(dataVec,peakList)
N = 4;
peakList = peakList(:)';
...
% std = 4;
% alpha = -4;
sumOfFSG = @(a1,a2,a3,a4,b1,b2,b3,b4,...
...
[fitResult,gof] = fit([0:2047]', dataVec', sumOfFSG,...
    'StartPoint',[1e3*ones(1,N),peakList,4,-4]...
    ,'Lower',[1e-2*ones(1,N),peakList - 50,0.5,-10]...
    ,'Upper',[1e4*ones(1,N),peakList + 50,10,-0.01]...
